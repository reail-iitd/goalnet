#this code is to calculate SJI and IED on verb level for acl and our model output
#for our mode, input is filtered version of fhpc outfile from analyse_test_output.py
#for acl, it is acl_predictions.txt
...
for i in range(4):
    ...
    count = 0
    file_name = "gfgf"
    with open("acl16_predictions.txt") as fp:
        lines = fp.readlines()
        for line in lines:
