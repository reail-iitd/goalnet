...
(:init (state icecream_1 scoopsleft) (state syrup_1 vanilla) (state syrup_2 chocolate) (on kettle stovefire_2) (on syrup_1 stovefire_2) (on energydrink_1 stovefire_4) (on coke_1 stovefire_4) (on canadadry_1 stovefire_4) (on plate_2 stovefire_4) (on syrup_2 stovefire_2) (on boiledegg_1 stovefire_4) (near robot microwave) (near robot fridge) (near robot syrup_1) ) 
(:goal (AND (grasping robot syrup_2) )) 
)