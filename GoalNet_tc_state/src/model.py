...
class GoalNet_Model(nn.Module):
    def __init__(self,
        ...
        self.pred_lstm = nn.LSTM(n_hidden, n_hidden)
    ...
    def forward(self, g, adj_matrix, goalVec, goalObjectsVec, pred, pred_inv, lstm_hidden=None):
        ...
        pred_hist, lstm_hidden = self.pred_lstm(torch.cat([h_embed]).view(1,1,-1), lstm_h)
